...
hacker="gst-libav gst-plugins-bad gst-plugins-base gst-plugins-good gst-plugins-ugly gstreamer-vaapi i3-wm i3status qutebrowser zathura" 
...
function install_big { 
	...
	arch-chroot /mnt env CFLAGS="-Wno-narrowing" pip install -U cld2-cffi
